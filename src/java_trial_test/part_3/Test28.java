...
/**
 * 28. You are taking over an aquarium simulation project. Your predecessor created a generic Fish class that includes
 * an oxygenConsumption method declared as follows:
 * <p>
 * public float oxygenConsumption( float temperature )
 * <p>
 * The aquarium simulation sums oxygen consumption for all fish in the tank with the following code fragment, where
 * fishes is an array of Fish object references:
 * <p>
